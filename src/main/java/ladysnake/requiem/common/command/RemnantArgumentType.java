...
public class RemnantArgumentType implements ArgumentType<RemnantType> {
    ...
    private static final SimpleCommandExceptionType BAD_IDENTIFIER = new SimpleCommandExceptionType(new TranslatableTextContent("argument.id.invalid"));
    public static final DynamicCommandExceptionType NOT_FOUND_EXCEPTION = new DynamicCommandExceptionType(o -> new TranslatableTextContent("requiem:remnant_type.not_found", o));
