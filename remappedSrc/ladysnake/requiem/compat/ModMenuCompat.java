...
public final class ModMenuCompat implements ModMenuApi {
    ...
    public static class ClothConfigScreenFactory implements ConfigScreenFactory<Screen> {
        ...
        private AbstractConfigScreen appendInfo(AbstractConfigScreen screen) {
            ...
            screen.getCategorizedEntries().put(new TranslatableTextContent("config.requiem.more"), Collections.singletonList(entry));
            return screen;
        }

        private AbstractConfigEntry<?> createInfoEntry() {
            return ConfigEntryBuilder.create()
                .startTextDescription(new TranslatableTextContent(
                    "config.requiem.more_info",
                    makeUrlText(new TranslatableTextContent("config.requiem.more_info.datapacks"), getLocalizedDataPackUrl()),
                    makeUrlText(new TranslatableTextContent("config.requiem.more_info.gamerules"), getLocalizedGameRuleUrl()),
                    makeUrlText(new TranslatableTextContent("config.requiem.more_info.official_doc"), "https://ladysnake.github.io/wiki/requiem/configuration")
        ...
        private MutableText makeUrlText(MutableText text, String url) {
            return text.styled(style -> style
                .withHoverEvent(new HoverEvent(HoverEvent.Action.SHOW_TEXT, new LiteralTextContent(url)))
